...
void State_Paused::OnCreate(){
    ...
    evMgr->AddCallback(StateType::Pause,"Key_P",&State_Paused::Unpause,this);
}
...
void State_Paused::Unpause(EventDetails* l_detalis __attribute((unused))){
...
void State_Paused::Update(const sf::Time &  l_time __attribute((unused))){}
